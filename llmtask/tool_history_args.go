...
// OpenAI-compatible history stores function.arguments as a JSON string. Transformers
// templates require an object by default; DeepSeek V3-family and full R1 keep the string.
